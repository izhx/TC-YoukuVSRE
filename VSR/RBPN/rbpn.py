...
class RBPN(nn.Module):
    def __init__(self, num_channels, base_filter, feat, num_stages, n_resblock, n_frames, scale_factor):
        ...
        # DBPNS
        self.DBPN = DBPN(base_filter, feat, num_stages, scale_factor)
        ...
        # Reconstruction
        self.output = ConvBlock((n_frames - 1) * feat, num_channels, 3, 1, 1, activation=None, norm=None)
